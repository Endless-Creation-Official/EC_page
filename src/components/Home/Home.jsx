    ...
    const handleScroll = () => {
      ...
      if (
        ...
        const animate = (timestamp) => {
          ...
          const animatedMemberCount = Math.min(
            Math.floor((progress / 4000) * endingMemberCount),
            endingMemberCount
          );
          const animatedProjectCount = Math.min(
            Math.floor((progress / 4000) * endingProjectCount),
            endingProjectCount
          );
          ...
          const animatedEstablishmentYear =
            2024 -
            Math.floor(
              establishmentYearProgress * (2024 - startingEstablishmentYear)
            );
          setEstablishmentYear(animatedEstablishmentYear);

          if (
            animatedMemberCount === endingMemberCount &&
            animatedProjectCount === endingProjectCount &&
            animatedEstablishmentYear === startingEstablishmentYear
          ) {
...
const projects = [
  {
    imageLink: './projectimage/duting-app.webp',
  ...
  {
    imageLink:
      'https://user-images.githubusercontent.com/33178048/186322211-26ec4031-cf03-4e75-8fe9-d9c5c2674858.png',
    mainLink: 'https://github.com/Endless-Creation-32nd/refill-front',
  },
  {
    imageLink:
      'https://user-images.githubusercontent.com/28949165/128898118-1ada994a-e8b0-480f-b93a-c682f2ae6baa.gif',
    mainLink: 'https://github.com/woori-hippy/hippy_front',
  },
  {
    imageLink:
  ...
  {
    imageLink: './projectimage/토이프로젝트.webp',
    mainLink: 'https://github.com/gom-3/dutying-web',
  },
  {
    imageLink: './projectimage/알고리즘스터디.webp',
    mainLink: '알고리즘 스터디',
  },
  { imageLink: './projectimage/React스터디.webp', mainLink: '리액트 스터디' },
  {
    imageLink: './projectimage/머신러닝스터디.webp',
    mainLink: '머신러닝 스터디',
  },
...
function ProjectSlide() {
  ...
  const randerSlides = () =>
    projects.map((element) => (
      <div className={styles.projectContainer} key={element.imageLink}>
        <img
  ...
  return (
    <div className={styles.project}>
      ...
      <label className={styles.dropdown}>
        <div className={styles.ddbutton}>프로젝트 & 스터디 더보기</div>
        ...
        <ul className={styles.ddmenu}>
          <li>
            <a
              href='https://www.notion.so/fc2751a8f4d042dfbf02eede5c7ab6df'
              target='_blank'
          ...
          <li>
            <a
              href='https://lnseo.notion.site/c83527196fc74296b4e9603cd4f6fefd'
              target='_blank'
              rel='noopener noreferrer'
            >
              32기(학술부)
          ...
          <li>
            <a
              href='https://lnseo.notion.site/92ecbae96b2d41c886df4d30f3ef4516'
              target='_blank'
              rel='noopener noreferrer'
            >
              32기(개발부)
...
const faqData = [
  {
    ...
    answer:
      '1학기에 신입생분들은 학술부장의 주도 하에 C 스터디를 진행합니다. 2, 3학년의 경우, 인원을 모아 프로젝트나 CS지식 등 분야에 관계없이 자유롭게 스터디를 진행합니다. 2학기에는 팀을 형성하여 1학기에 쌓은 지식을 기반으로 다양한 프로젝트에 도전하게 됩니다.',
  },
  {
    question: '개발 경험이 거의 없는데, 활동할 수 있을까요?',
    answer:
      '네! EC는 열정 넘치는 사람들이 모여 함께 성장하는 것을 추구합니다. 따라서 개발 경험과 실력보다는 배우고자 하는 열정과 이루고자 하는 목표를 더 중요시합니다. 여러분의 뜨거운 열정을 기대하겠습니다!',
  },
  {
    question: 'EC에서 얻어갈 수 있는 것이 무엇인가요?',
    answer:
      'EC에서는 선후배 간의 네트워킹, 세미나와 다양한 프로젝트를 통해 성장할 수 있는 소중한 경험을 제공합니다. 또한, 이를 토대로 각자의 포트폴리오를 구축할 수 있는 기회를 마련하고 있습니다.',
  },
  {
    question: '스터디 외에 어떤 다른 활동을 하나요?',
    answer:
      '스터디 외에 MT, 한강나들이, 짝선배-짝후배 등 친목 활동을 하며 동아리원들과의 추억을 쌓습니다. 이외에도 공부하다 지친다면 자유롭게 인원을 구성하여 놀러가셔도 됩니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '정기 세션에서는 스터디 & 프로젝트의 진행 상황을 공유하고 발표하며 피드백을 주고 받는 시간을 가지며 세미나에서는 졸업한 선배들이 후배들을 위해 특강을 진행해 주십니다. 선배의 특강에는 분야별 공부 방법, 하는 일, 학교 생활 등을 주 컨텐츠로 다룹니다. 정기 세션과 세미나 종료 후에는 회원 간의 소통을 촉진하기 위해 회식이 준비되어 있습니다. 함께 지낸 시간을 더욱 소중하게 만들어 줄 특별한 순간들이 기다리고 있습니다.',
  },
];
