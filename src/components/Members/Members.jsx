  ...
  return (
    <div className={styles.graduatescard}>
      <div className={styles.graduatesheadercontainer}>
        ...
        {mark && (
          <img src={mark} className={styles.companyMark} alt='companyMark' />
        )}
        {showHamburger && (
          <div
      ...
      <div>
        {showAllCareers ? (
          ...
          <div className={styles.careers}>{careers[careers.length - 1]}</div>
        )}
      </div>
    </div>
  );
...
function Main() {
  ...
  const handleClick = () => {
    ...
    const topOffset =
      graduatesSectionRef.current.offsetTop -
